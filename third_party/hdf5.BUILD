...
# From: https://raw.githubusercontent.com/tensorflow/io/master/third_party/hdf5.BUILD
# Edits:
# Removed Windows support, ignored several warnings
...
cc_library(
    ...
    # Squelch the multitude of lovely warnings that hdf5 has
    copts = [
        "-Wno-unused-variable",
        "-Wno-unused-function",
